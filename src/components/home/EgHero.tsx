  ...
  return (
    <section className="eg-hero" aria-label="Hero">
      <style>{`
        ...
        /* full-bleed background video - promoted to its own compositor
           layer so scrolling over it never triggers a repaint (kills the
           site-wide scroll jank the heavy video was causing) */
        .eg-hero-bg {
